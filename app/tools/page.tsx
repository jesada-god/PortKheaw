      ...
      <div className="w-full max-w-full min-w-0 space-y-8 p-4 md:p-8">
        ...
        */}
        {TOOL_CATEGORIES.map((category) => {
          ...
          return (
            <section key={category} className="min-w-0 space-y-4">
              <h2 className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">{category}</h2>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative z-10 min-w-0">
                        ...
                        */}
                        <p data-testid={`tool-audience-${tool.id}`} className="mt-2 break-words text-xs leading-5 text-slate-500">
                          {tool.audience}
                        </p>
                        {!unlocked && (
                          <>
