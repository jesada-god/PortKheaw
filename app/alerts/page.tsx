...
export default async function AlertsPage() {
  ...
  return <div><Header title="การแจ้งเตือนราคา" backFallbackHref="/settings" subtitle="ระบบตรวจราคาตามรอบอัตโนมัติ โดยใช้ข้อมูลราคาที่ผ่านเกณฑ์เดียวกับหน้าภาพรวมและหน้าพอร์ต" /><div className="mx-auto max-w-4xl p-4 md:p-8"><AlertsClient initialAlerts={alerts} /></div></div>;
}
