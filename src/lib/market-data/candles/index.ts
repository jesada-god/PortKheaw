...
let yahooProvider: YahooCandleProvider | undefined;

export function getYahooChartProvider(): YahooCandleProvider {
  yahooProvider ??= new YahooCandleProvider();
...
export function getCandleMarketDataService(): CandleMarketDataService {
  ...
  service ??= new CandleMarketDataService([getYahooChartProvider()]);
  return service;
}
