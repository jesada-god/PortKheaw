      ...
      blocks: [
        {
          ...
          items: [
            ...
            `ข้อมูลแฮชเพื่อป้องกันการใช้สิทธิทดลองซ้ำถูกเก็บไว้ ${TRIAL_IDENTITY_RETENTION_YEARS} ปีนับจากวันที่ใช้สิทธิ `
            + 'จากนั้นจะถูกลบ ข้อมูลชุดนี้ถูกจำกัดสิทธิ์ให้เข้าถึงได้เฉพาะระบบเบื้องหลังเท่านั้น '
